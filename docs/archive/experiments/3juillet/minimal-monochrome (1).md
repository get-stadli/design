...
- Don't compress section breaks below 96px, even on dense pages — cut content before cutting air.
...
Multi-column grids stack to one column, nav links collapse to a menu, and side-by-side media and text reflow to stacked. The primary CTA never hides. On mobile, section breaks may step down one token (144px → 96px) but never below.
